    ...
    <div class="form-group {{ $errors->has('email') ? ' has-danger' : '' }}">
        ...
        <input type="email" name="email" id="form_client_email" class="form-control {{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="{{ __('Email') }}" value="{{ $client->email }}">
    ...
    <div class="form-group {{ $errors->has('num_permis') ? ' has-danger' : '' }}">
        ...
        <input type="text" name="num_permis" id="form_client_num_permis" class="form-control {{ $errors->has('num_permis') ? ' is-invalid' : '' }}" placeholder="{{ __('Num permis') }}" value="{{ $client->num_permis }}">
    ...
    <div class="form-group {{ $errors->has('telephone') ? ' has-danger' : '' }}">
        ...
        <input type="text" name="telephone" id="form_client_telephone" class="form-control {{ $errors->has('telephone') ? ' is-invalid' : '' }}" placeholder="{{ __('Num télephone') }}" value="{{ $client->telephone }}">
    ...
    <div class="form-group {{ $errors->has('pays') ? ' has-danger' : '' }}">
        ...
        <input type="text" name="pays" id="form_client_pays" class="form-control {{ $errors->has('pays') ? ' is-invalid' : '' }}" placeholder="{{ __('Pays') }}" value="{{ $client->pays }}">
    ...
    <div class="form-group {{ $errors->has('code_postal') ? ' has-danger' : '' }}">
        ...
        <input type="text" name="code_postal" id="form_client_code_postal" class="form-control {{ $errors->has('code_postal') ? ' is-invalid' : '' }}" placeholder="{{ __('Code postal') }}" value="{{ $client->code_postal }}">

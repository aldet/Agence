...
<input type="text" name="nom_categorie" id="form_categorie_vehicule" required class="form-control{{$errors->has('categorie_vehicule') ? 'has-danger' : ''}}" placeholder="{{__('Categorie')}}" value="{{$categorie->categorie_vehicule}}">
